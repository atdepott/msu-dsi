define([], function () {
    var configOptions = {
        "title": "Surface Interpolation Tool - Nearest Neighbor",
        "interpolationType": "NN", // options: IDW, NN, or SPLINE
        "interpolationHtml": "<p>\"The algorithm used by the Natural Neighbor interpolation tool finds the closest subset of input samples to a query point and applies weights to them based on proportionate areas to interpolate a value (Sibson 1981).\" -Esri, 2014. For more information, see the ArcGIS documentation <a href='http://resources.arcgis.com/en/help/main/10.2/index.html#/How_Natural_Neighbor_works/009z00000077000000/' target='_blank'>here</a>.</p>",
